...
class UserServiceTest {
    ...
    void testGetUserByEmail_UserNotInCache() {
        ...
        when(userRepository.findByEmail("Linkong344@gmail.com")).thenReturn(Optional.of(userFromDatabase));
    ...
    void testGetUserByEmail_UserNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> userService.getUserByEmail("Linkong344@gmail.com"));
    }
    ...
    void testGetUserCoordinatesListByNickname_DataInCache() {
        ...
        verify(userRepository, never()).findByNickname(anyString());
        verify(coordinatesRepository, never()).findByUserSetContaining(any(User.class), any(Pageable.class));
    }
    ...
    void testGetUserCoordinatesListByNickname_DataNotInCache() {
        ...
        when(coordinatesRepository.findByUserSetContaining(eq(user), any(Pageable.class))).thenReturn(coordinatesPage);
    ...
    void testUpdateUserByNickname_UserNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> userService.updateUserByNickname("Willygodx", updateDto));
    }
    ...
    void testUpdateUserByNickname_Failure() {
        ...
        assertThrows(BadRequestErrorException.class, () -> userService.updateUserByNickname("Willygodx", updateDto));
    }
    ...
    void testUpdateUserByEmail_UserNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> userService.updateUserByEmail("Linkong344@gmail.com", updateDto));
    }
    ...
    void testUpdateUserByEmail_Failure() {
        ...
        assertThrows(BadRequestErrorException.class, () -> userService.updateUserByEmail("Linkong344@gmail.com", updateDto));
    }
